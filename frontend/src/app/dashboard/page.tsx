      ...
      <div className="border border-gray-300 rounded-lg bg-[#FFFFFF] p-5 flex items-center justify-between">
        <div className="flex items-start space-x-6">
          <div className="flex flex-col items-start">
            <span className="text-md font-black text-blue-700 uppercase">
              {month}
            </span>
    ...
    <PageContainer>
      <div className="p-6">
        <div className="flex justify-between items-center">
          <h2 className="text-2xl font-semibold text-eb-purple mt-12 ">
            Dashboard
          </h2>
        </div>
      ...
      <div className="p-6 flex-grow">
        <div className="flex justify-between items-center mb-2">
          <h3 className="text-lg text-eb-purple font-medium ">

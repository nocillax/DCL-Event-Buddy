  ...
  return (
    <PageContainer>
      <div className="pt-6 mt-16">
        <button
          onClick={() => router.push('/')}
          className="text-eb-purple flex items-center gap-2 mb-4"
        >
          <FaArrowLeft />
          Back to event
        </button>
        ...
        <h1 className="text-3xl font-semibold text-eb-purple mt-6 mb-4">
          {event.title}
        </h1>
        ...
        <div className="bg-[#FFFFFF] rounded-xl border border-gray-200 flex flex-wrap md:flex-nowrap justify-between items-start px-6 py-4 mb-8 shadow-sm">
          ...
          <div className="flex items-start gap-3 w-full md:w-1/3 mb-4 md:mb-0 justify-center">
            ...
            <div className="flex flex-col text-sm text-gray-700">
              ...
              <span>
                {dayjs(`2024-01-01T${event.startTime}`).format('h:mm A')} –{' '}
                {dayjs(`2024-01-01T${event.endTime}`).format('h:mm A')}
              </span>
            </div>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 mb-8 shadow-sm max-w-3xl mx-auto">
          <p className="font-medium text-eb-purple mb-6 text-left text-lg">
          ...
          <div className="flex justify-center gap-6 mb-10 flex-wrap">
            {[1, 2, 3, 4].map((n) => (
              ...
              >
                ...
                <span className="text-xs text-[#8570AD] font-semibold mt-0.5">
                  {n === 1 ? 'Seat' : 'Seats'}
                </span>
              </button>
            ))}
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-medium text-eb-purple mb-2">
            About this event
          </h2>
          <p className="text-base text-[#8570AD] whitespace-pre-line leading-relaxed">
            {event.description}
          </p>
        </div>
